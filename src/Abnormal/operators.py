...
class ABN_OT_store_norms_in_attr(Operator):
    ...
    bl_options = {"REGISTER", "UNDO", "INTERNAL"}
    bl_description = 'Convert current custom normals to the selected Face Corner Attribute'
...
class ABN_OT_convert_attr_to_norms(Operator):
    ...
    bl_options = {"REGISTER", "UNDO", "INTERNAL"}
    bl_description = 'Convert selected Face Corner Attribute to custom normals'
